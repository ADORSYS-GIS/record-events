    ...
    setTimeout(() => {
      const labels: Label[] = [
        ...
        },
        {
          labelId: "locality",
          name_en: "Locality",
          name_fr: "Village/Quartier",
          type: "enum",
          required: true,
          placeholder: "Village/Quartier - Locality",
          helpText: "Le village ou quartier - The locality",
          options: [],
          dependsOn: "3",
          category: "event_details",
        },
        {
          ...
          type: "enum",
          required: true,
          placeholder: "Bureau de Vote - Polling Station",
          helpText: "Le bureau de vote - The polling station",
          options: [],
          dependsOn: "locality",
          category: "event_details",
        },
        {
          labelId: "other_locality",
          name_en: "Other Locality",
          name_fr: "Autre Village/Quartier",
          type: "text",
          required: false,
          placeholder: "Autre Village/Quartier - Other Locality",
          helpText: "Autre village/quartier - Other locality",
          category: "event_details",
        },
        {
          labelId: "other_station",
          name_en: "Other Polling Office",
