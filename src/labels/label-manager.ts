    ...
    setTimeout(() => {
      const labels: Label[] = [
        ...
        },
        {
          ...
          type: "text",
          required: true,
          placeholder: "enterPollingStationPlaceholder",
          helpText: "enterPollingStationDescription",
          category: "event_details",
        },
        {
          labelId: "5",
          ...
          type: "text",
          required: true,
          placeholder: "enterPollingOfficePlaceholder",
          helpText: "enterPollingOfficeHelpText",
          category: "event_details",
        },
        {
          labelId: "paul_biya",
