type ProjectEnvVariablesType = Pick<
  ImportMetaEnv,
  "VITE_REPORTHUB_WEBAUTH_RP_ID" | "VITE_REPORTHUB_WEBAUTH_RP_NAME"
>;
  ...
  return {
    envVariables: {
      VITE_REPORTHUB_WEBAUTH_RP_ID:
        !projectEnvVariables.VITE_REPORTHUB_WEBAUTH_RP_ID.includes(
          "VITE_REPORTHUB_",
        )
      ...
      VITE_REPORTHUB_WEBAUTH_RP_NAME:
        !projectEnvVariables.VITE_REPORTHUB_WEBAUTH_RP_NAME.includes(
          "VITE_REPORTHUB_",
        )
