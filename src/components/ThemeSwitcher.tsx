        ...
        <div className="absolute top-full right-0 mt-2 w-36 bg-white rounded-lg shadow-xl z-50 overflow-hidden">
          <button
            ...
            className={`w-full text-left px-4 py-2 text-sm font-medium flex items-center space-x-2 transition-colors duration-200 ${
              theme === "light" ? "bg-gray-100 text-gray-900" : "text-gray-700 hover:bg-gray-50"
            }`}
          >
          ...
          <button
            ...
            className={`w-full text-left px-4 py-2 text-sm font-medium flex items-center space-x-2 transition-colors duration-200 ${
              theme === "dark" ? "bg-gray-100 text-gray-900" : "text-gray-700 hover:bg-gray-50"
            }`}
          >
          ...
          <button
            ...
            className={`w-full text-left px-4 py-2 text-sm font-medium flex items-center space-x-2 transition-colors duration-200 ${
              theme === "system" ? "bg-gray-100 text-gray-900" : "text-gray-700 hover:bg-gray-50"
            }`}
          >
